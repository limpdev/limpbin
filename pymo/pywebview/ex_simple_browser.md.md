...
[Edit this page](https://github.com/r0x0r/pywebview/edit/docs/docs/examples/simple_browser.md)

[PrevSettings](/examples/settings)[NextToggle Fullscreen](/examples/toggle_fullscreen)
