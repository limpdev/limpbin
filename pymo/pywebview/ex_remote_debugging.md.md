...
Enable remote debugging when using `edgechromium`. This can be used to write tests for the application using Playwright. See <https://playwright.dev/docs/webview2> for how to configure it.
...
[Edit this page](https://github.com/r0x0r/pywebview/edit/docs/docs/examples/remote_debugging.md)

[PrevQt Test](/examples/qt_test)[NextResize](/examples/resize)
