...
A user-provided "drag region" to move a frameless window around, whilst maintaining normal mouse down/move events elsewhere. This roughly replicates `-webkit-drag-region`.
...
[Edit this page](https://github.com/r0x0r/pywebview/edit/docs/docs/examples/drag_region.md)

[PrevDrag Drop](/examples/drag_drop)[NextEvaluate Js](/examples/evaluate_js)
