...
[Edit this page](https://github.com/r0x0r/pywebview/edit/docs/docs/examples/settings.md)

[PrevScreens](/examples/screens)[NextSimple Browser](/examples/simple_browser)
